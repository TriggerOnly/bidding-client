...
import { Box, Typography, Paper, CircularProgress, Table, TableContainer, TableHead, TableRow, TableCell, TableBody, Button } from "@mui/material";
...
export const FullBidding = () => {
  ...
  if (!bidding || !participants) {
    return (
      <Typography variant="h6" color="error">
        Ошибка: данные торгов не найдены.
      </Typography>
    );
  }
